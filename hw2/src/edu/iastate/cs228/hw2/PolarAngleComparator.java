...
public class PolarAngleComparator implements Comparator<Point>
{
	...
	public int compare(Point p1, Point p2)
	{
		...
		//else if((crossProduct(p1,p2)>0) || ((crossProduct(p1,p2) == 0)&&(dotProduct(p1,p1) < dotProduct(p2,p2))))
		else if((comparePolarAngle(p1,p2)<0) || ((comparePolarAngle(p1,p2)==0) && (dotProduct(p1,p1) < dotProduct(p2,p2))))
		{
			return -1;
		}
		else
    ...
    {
    	if((p1.equals(p2))||((!p1.equals(referencePoint)&&!p2.equals(referencePoint)) && (crossProduct(p1,p2) == 0 && dotProduct(p1,p2)>0)))
    	{
    		return 0;
    	}
    	else if((p1.equals(referencePoint)) || ((!p2.equals(referencePoint)) && (((p1.getY() < referencePoint.getY() && p2.getY() < referencePoint.getY() && crossProduct(p1,p2) > 0))||((p1.getY()==referencePoint.getY()) && ((p2.getY()<referencePoint.getY())||(p2.getY() == referencePoint.getY() && p1.getX() > referencePoint.getX() && p2.getX() < referencePoint.getX())||(p2.getY() > referencePoint.getY() && p1.getX() > referencePoint.getX())))||((p1.getY()>referencePoint.getY())&&((p2.getY()>referencePoint.getY() && crossProduct(p1,p2)>0)||(p2.getY()==referencePoint.getY() && (p2.getX() < referencePoint.getX()))||(p2.getY()<referencePoint.getY()))))))
    	{
    		return -1;
    	}
    	else
